...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['kickass.vc', 'kickass2.cc', 'kickass2.how', 'kickasst.org', 'kickasstorrents.id', 'thekat.cc', 'thekat.ch', 'kickasstorrents.bz', 'kkickass.com', 'kkat.net', 'kickasst.net', 'kickasshydra.net', 'kickasshydra.org', 'kickass-kat.com', 'kickasstorrents.id', 'thekat.cc', 'thekat.ch']
