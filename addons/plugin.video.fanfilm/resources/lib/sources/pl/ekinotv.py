...
class source:
    ...
    def do_search(self, search_string, title, localtitle, year, search_type):
        ...
        r = client.request("https://ekino-tv.pl/s/search?q=%s" % str.lower(search_string + " HD").replace(" ", "+"), headers={'Cookie': cookies})
    ...
    def sources(self, url, hostDict, hostprDict):
        ...
        try:
            ...
            r = client.request(urlparse.urljoin(self.base_link, url), redirect=False, headers={'Cookie': cookies})
    ...
    def resolve(self, url):
        try:
            ...
            result = client.request(transl_url, redirect=False, headers={'Cookie': cookies + "; prch=true"})
            ...
            for script in scripts:
                if 'var url' in script:
                    ...
                    if not 'watch' in link:
                        ...
                        return link
                    result = client.request(link, headers={'Cookie': cookies + "; prch=true"})
