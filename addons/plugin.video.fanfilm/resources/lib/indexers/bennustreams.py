...
class indexer:
    ...
    def rotten_list(self, url):
        ...
        if u:
            r = [(dom_parser.parse_dom(i, 'a', req='href'), \
                  dom_parser.parse_dom(i, 'span', {'class': 'subtle'}), \
                  dom_parser.parse_dom(i, 'span', {'class': 'tMeterScore'}), \
                  dom_parser.parse_dom(i, 'img', req='src'), \
                  dom_parser.parse_dom(i, 'p')) for i in u]
    ...
    def trakt_list(self, url):
        ...
        r = [(i.attrs['data-runtime'], \
              dom_parser.parse_dom(i, 'img', {'class': 'real'})) for i in u]
