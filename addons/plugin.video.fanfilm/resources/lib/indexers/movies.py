...
class movies:
    def __init__(self):
        ...
        self.tm_user = control.setting('tm.userF')
        self.fanart_tv_user = control.setting('fanart.tv.userF')
        self.user = str(control.setting('fanart.tv.userF')) + str(control.setting('tm.userF'))
        ...
        self.year_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=100,&production_status=released&year=%s,%s&sort=moviemeter,asc&count=' + listscount + '&start=1'
#       self.year_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=100,&production_status=released&year=%s,%s&sort=' + moviessort + '&count=' + listscount + '&start=1'
        self.action_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=action&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.adventure_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=adventure&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.animation_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=animation&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.anime_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&keywords=anime&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.biography_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=biography&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.comedy_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=comedy&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.crime_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=crime&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.documentary_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=documentary&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.drama_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=drama&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.family_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=family&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.fantasy_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=fantasy&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.history_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=history&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.horror_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=horror&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.music_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=music&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.musical_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=musical&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.mystery_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=mystery&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.romance_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=romance&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.sci_fi_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=sci_fi&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.sport_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=sport&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.thriller_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=thriller&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.war_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=war&sort=moviemeter,asc&count=' + listscount + '&start=1'
        self.western_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=western&sort=moviemeter,asc&count=' + listscount + '&start=1'
        ...
        self.y2010_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=2010-01-01,date[90]&sort=moviemeter,asc&count=' + listscount + '&start=1'
    ...
    def worker(self, level=1):
        ...
        self.fanart_tv_headers = {'api_key': control.setting('fanart.tv.devF')}
    ...
    def super_info(self, i):
        try:
            ...
            try:
                ...
                control.setting('fanart.tv.devF'), self.fanart_tv_user), headers=self.fanart_tv_headers, timeout='10',
                                     error=True)
                try:
                    art = json.loads(art)
                except:
