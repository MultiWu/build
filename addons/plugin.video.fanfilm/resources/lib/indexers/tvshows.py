...
class tvshows:
    def __init__(self):
        ...
        self.user = control.setting('fanart.tv.userF') + str('')
...
#       self.year_link = 'TEST'
        self.action_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=action&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.adventure_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=adventure&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.animation_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=animation&sort=moviessort,asc&count=' + listscount + '&start=1'
        ...
        self.biography_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=biography&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.comedy_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=comedy&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.crime_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=crime&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.drama_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=drama&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.family_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=family&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.fantasy_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=fantasy&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.game_show_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=game_show&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.history_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=history&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.horror_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=horror&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.music_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=music&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.musical_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=musical&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.mystery_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=mystery&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.news_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=news&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.reality_tv_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=reality_tv&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.romance_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=romance&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.sci_fi_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=sci_fi&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.sport_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=sport&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.talk_show_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=talk_show&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.thriller_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=thriller&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.war_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=war&sort=moviessort,asc&count=' + listscount + '&start=1'
        self.western_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=western&sort=moviessort,asc&count=' + listscount + '&start=1'
